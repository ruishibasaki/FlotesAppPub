...
public:
    randomOrderBestPositionInsertion(const InstanceData & data_): Operations(data_){ }
...
public:
    twoRegretInsertion(const InstanceData & data_): Operations(data_){ }
...
public:
    sharpWindowOrderBestPositionInsertion(const InstanceData & data_): Operations(data_){ }
...
public:
    demandOrderBestPositionInsertion(const InstanceData & data_): Operations(data_){ }
...
public:
    closestOrderBestPositionInsertion(const InstanceData & data_): Operations(data_){ }
...
public:
    farestOrderBestPositionInsertion(const InstanceData & data_): Operations(data_){ }
...
public:
    noServeOrderBestPositionInsertion(const InstanceData & data_): Operations(data_){ }
